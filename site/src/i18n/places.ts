...
export const places = {
  en: {
    ...
    arrondissementsBody: "The city is divided into arrondissements, shaded here by density.",
  ...
  fr: {
    ...
    arrondissements: "Arrondissements",
    arrondissementsBody: "La ville est divisée en arrondissements, colorés ici selon la densité.",
