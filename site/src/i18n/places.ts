...
export const places = {
  en: {
    ...
    ageBodyThen: "Men and women by age, each as a share of their own. The outline is the same share in 2014.",
  ...
  fr: {
    ...
    ageBodyThen: "Hommes et femmes par âge, chacun en part de son sexe. Le trait donne la même part en 2014.",
