...
export const places = {
  en: {
    ...
    ageBodyThen: "Men and women by age, each as a share of their own. The outline is the same share in {year}.",
    ...
    censusGroup: "Census",
    tickIs: "The tick is the same share in {year}.",
  ...
  fr: {
    ...
    ageBodyThen: "Hommes et femmes par âge, chacun en part de son sexe. Le contour donne la même part en {year}.",
    ...
    tickIs: "Le repère donne la même part en {year}.",
