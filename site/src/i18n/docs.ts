...
export const docs = {
  en: {
    ...
    mcp: {
      ...
      byPromptText: [
        "Add an MCP server to your own configuration. It's called",
        "{name} and it's at:",
        "",
        "{url}",
        "",
        "It speaks Streamable HTTP and needs no key or sign-in. Every tool it",
        "offers only reads. Put it wherever you keep MCP servers, tell me which",
        "file you changed and whether I need to restart, then call it once and",
        "tell me which province Tafraout is in.",
      ],
  ...
  fr: {
    ...
    mcp: {
      ...
      byPromptText: [
        "Ajoutez un serveur MCP à votre propre configuration. Il s’appelle",
        "{name} et il est à :",
        "",
        "{url}",
        "",
        "Il parle HTTP streamable et ne demande ni clé ni compte. Tous ses",
        "outils ne font que lire. Mettez-le là où vous enregistrez vos serveurs",
        "MCP, dites-moi quel fichier vous avez modifié et s’il faut redémarrer,",
        "puis appelez-le une fois et dites-moi dans quelle province se trouve",
        "Tafraout.",
      ],
      claudeCode: "Claude Code",
