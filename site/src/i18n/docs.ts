...
export const SPEC_FR: Record<string, string> = {
  ...
  "getEconomy.description":
    ...
    "L’agriculture n’y est pas : tous les autres secteurs le sont. Les 6 villes à arrondissements sont comptées par arrondissement et n’ont pas de fichier propre. " +
  ...
  "getEconomy.404": "Aucune unité ne porte cet identifiant, elle est dans une autre collection, ou elle est comptée par arrondissement.",
  ...
  en: {
    ...
    indicators: {
      ...
      establishmentsBody: [
        ...
        "The 6 cities with arrondissements are counted by arrondissement and carry no figures of their own. Urban centres have none: the workbook stops at the commune.",
  ...
  fr: {
    ...
    indicators: {
      ...
      establishmentsBody: [
        ...
        "Les 6 villes à arrondissements sont comptées par arrondissement et n’ont pas de chiffres propres. Les centres urbains n’en ont pas : le fichier s’arrête à la commune.",
