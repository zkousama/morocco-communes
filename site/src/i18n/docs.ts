...
export const docs = {
  en: {
    ...
    python: {
      ...
      description: "morocco-communes: the dataset as pandas DataFrames, offline, with the census figures and the establishments.",
      lede: "Every table as a DataFrame, offline: the units, both censuses, and the establishments.",
      install: "Install",
      ...
      dictionaryBody: [
        "`fields(\"indicators\")`, `fields(\"indicators2014\")` and `fields(\"economy\")` give the column, an English label, HCP’s own heading and the unit.",
  ...
  fr: {
    ...
    python: {
      title: "Paquet Python",
      description: "morocco-communes : le jeu de données en DataFrames pandas, hors ligne, avec les chiffres du recensement et les établissements.",
      lede: "Chaque table en DataFrame, hors ligne : les unités, les deux recensements et les établissements.",
      install: "Installer",
      ...
      dictionaryBody: [
        "`fields(\"indicators\")`, `fields(\"indicators2014\")` et `fields(\"economy\")` donnent la colonne, un libellé en anglais, l’intitulé du HCP et l’unité.",
