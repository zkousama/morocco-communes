...
export const ui = {
  en: {
    ...
    dlIndicators: "2024 census figures, with fields.json naming each one. The communes are in communes/, a file per région",
    dlIndicators2014: "2014 census figures, in the same shape",
    dlEconomy: "Economic establishments counted in 2024",
    dlHousing: "The urban housing stock in 2024, by dwelling rather than by household",
    dlAdjacency: "Which communes border which, and how much boundary they share",
    dlSources: "Sources",
  ...
  fr: {
    ...
    dlIndicators: "Chiffres du recensement de 2024, avec fields.json qui nomme chacun. Les communes sont dans communes/, un fichier par région",
    dlIndicators2014: "Chiffres du recensement de 2014, dans la même forme",
    dlEconomy: "Établissements économiques recensés en 2024",
    dlHousing: "Le parc logement urbain en 2024, par logement plutôt que par ménage",
    dlAdjacency: "Quelles communes se touchent, et sur quelle longueur",
    dlSources: "Sources",
