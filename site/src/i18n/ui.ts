...
export const ui = {
  ...
  ary: {
    ...
    tierAliasBody: "Query string ma ymknch ykhtar file, dakchi alach requests li mktobin hakda kaythwlo l l-file li fih l-jawab aslan, w response katsmih.",
    ...
    dataBody: "Dataset fih versions f repo, dakchi alach ymkn ytkheddem bla had l-API ga'. Licences mbdlin ela hsab folder: l-khasayis jayin mn l-ihsa, w l-hdod fihom share-alike.",
    searchTab: "Qllb",
