...
export const LEVELS: Record<Locale, Record<string, string>> = {
  ...
  ary: { region: "jiha", province: "amala", cercle: "daira", commune: "jamaa", arrondissement: "muqataa" },
};
...
export const ui = {
  ...
  ary: {
    ...
    lookupTab: "Lookup",
    lookupHint: "Jamaa wahda b l-code wla b slug. R-rbaa dyal l-kitabat kolhom kaywslo l nefs r-record.",
    fieldQuery: "Qelleb ala",
    fieldRadius: "Radius b km",
    fieldIdentifier: "Code wla slug",
    run: "Lanci",
    running: "Kayekhdem",
    request: "Request",
    tier: "Jaweb bih",
