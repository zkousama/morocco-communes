...
export const ui = {
  ...
  ary: {
    ...
    tiersHeading: "Fin kaytjawb l-request",
    ...
    tierPre: "File f CDN",
    tierPreBody: "3,852 responses mktobin mlli kaysawbo l-site. Hta haja ma katkhdm bach tservihom, dakchi alach ma kayqamo b walo w kaytsnndo l ay trafique.",
    tierAlias: "Rewrite l dak l-file",
    tierAliasBody: "Query string ma ymknch ykhtar file, dakchi alach requests li mktobin hakda kaythwlo l l-file li fih l-jawab aslan, w l-response katsmih.",
    tierComputed: "Mhsoub f l-waqt",
    tierComputedBody: "L-bhth, queries b d-dayira, w l-filters li ma kaynin f hta file wahd. Hado homa requests l-wahdin li kaykhllso chi haja.",
    dataHeading: "Khod kolchi",
    dataBody: "L-dataset fih versions f l-repo, dakchi alach ymkn ytkheddem bla had l-API ga'. L-licences mbdlin ela hsab l-folder: l-khasayis jayin mn l-ihsa, w l-hdod fihom share-alike.",
    searchTab: "Qllb",
    ...
    failed: "Dak l-request ma kmlch. Chof wach l-API kheddam, w awd jrb.",
    theme: "Theme",
    themeAuto: "Auto",
    themeLight: "Dawi",
    themeDark: "Mdlm",
    chartsHeading: "Chno kaybino larqam",
    chartsBody: "Tlata d lhwayej mofidin qbl ma tbni b hadchi, kol whda makhoda mn l-dataset machi mktoba b jnbha.",
