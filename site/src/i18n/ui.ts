...
export const ui = {
  ...
  ary: {
    ...
    intro: "Rmooz rasmiya mn HCP, smayat b lfransawiya w larbiya, sokkan mn ihsa 2024 w 2014, w lhdod d kol jama'a mn ghir whda. Faboor fl-istima'l w faboor fl-khdma.",
    mapCaption: "Kol 1,502 hdod, mrsoomin mn files li katservi had API.",
    mapSource: "data/v1/geometry · OpenStreetMap, ODbL",
    ...
    tryBody: "Kol request lteht katmchi l had API w katrja' bla tbddil.",
    tiersHeading: "Fin kaytjawb request",
    tiersBody: "Tlata d lblays, w header X-Api-Tier f kol response kaybin ina whda. Aghlabiya d requests ma kaywslo l hta code.",
    ...
    tierAlias: "Rewrite l dak file",
    tierAliasBody: "Query string ma ymknch ykhtar file, dakchi alach requests li mktobin hakda kaythwlo l file li fih l-jawab aslan, w response katsmih.",
    tierComputed: "Mhsoub f l-waqt",
    tierComputedBody: "L-bhth, queries b d-dayira, w filters li ma kaynin f hta file wahd. Hado homa requests l-wahdin li kaykhllso chi haja.",
    dataHeading: "Khod kolchi",
    dataBody: "Dataset fih versions f repo, dakchi alach ymkn ytkheddem bla had API ga'. Licences mbdlin ela hsab folder: l-khasayis jayin mn l-ihsa, w l-hdod fihom share-alike.",
    searchTab: "Qllb",
    ...
    failed: "Dak request ma kmlch. Chof wach API kheddam, w awd jrb.",
    theme: "Theme",
    themeAuto: "Auto",
    themeLight: "Dawi",
    themeDark: "Mdlm",
    ...
    chartSpread: "Wach crosswalk shih",
    chartSpreadBody: "207 jama'a tbdlo larqam dyalhom b islah 2015, dakchi alach sokkan dyalhom d 2014 kan khasshom ytlaqaw b smya w l-iqsa machi ytpqraw mn code ma tbdlch. Kon kano had matchat ghaltin, kon zyadathom tfreqat b chkl akhor.",
    spreadUnchanged: "Code ma tbdlch mn 2014",
    spreadCrosswalk: "Tbdlo larqam, mtlaqyin b crosswalk",
    chartSpreadNote: "L-khet kayched mn l-10th tal 90th percentile, l-carré mn 25th tal 75th, w l-khet l-wstani hwa median. Had jouj distributions mhotin qrib foq ba'dhom, hada dalil bli had match mzyan — machi ithbat qa'te, w l-fhamat d kol zoj kayna f data/v1/crosswalk.",
    footerData: "Rmooz w sokkan mn Haut-Commissariat au Plan, RGPH 2024 w RGPH 2014.",
