...
export const ui = {
  en: {
    ...
    refAll: "all",
    pQ: "Text to find, in French, Arabic or as a slug",
    ...
    pCommunesQ: "Searches communes only",
    dlCommunes: "Communes",
    dlRegions: "Régions",
  ...
  fr: {
    ...
    refAll: "tous",
    pQ: "Texte à chercher, en français, en arabe ou en slug",
    ...
    pCommunesQ: "Ne cherche que parmi les communes",
    dlCommunes: "Communes",
    dlRegions: "Régions",
