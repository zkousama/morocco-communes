...
export const ui = {
  en: {
    ...
    intro:
      "Official HCP codes, names in French and Arabic, population from the 2024 and 2014 censuses, and a boundary for every commune but one. Free to use.",
    ...
    useBody: "",
    useCommunes: "A page for every place",
  ...
  fr: {
    ...
    intro:
      "Codes officiels du HCP, noms en français et en arabe, population des recensements de 2024 et 2014, et une limite pour chaque commune sauf une. Libre d’usage.",
    ...
    useBody: "",
    useCommunes: "Une page pour chaque lieu",
