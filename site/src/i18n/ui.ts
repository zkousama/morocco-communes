...
export const PAGES = ["", "communes/", "docs/api/", "docs/mcp/", "docs/components/", "docs/npm/", "docs/python/", "docs/indicators/", "docs/glossary/", "docs/insights/", "docs/privacy/", "most-looked-up/"] as const;
...
export const ui = {
  en: {
    ...
    findLevels: { commune: "commune", arrondissement: "arrondissement", province: "province", prefecture: "préfecture", region: "région" } as Record<string, string>,
    findClear: "Clear",
    menuExplore: "Explore",
    menuBuild: "Build",
