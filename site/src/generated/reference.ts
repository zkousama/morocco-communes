      ...
      "/api/{collection}/{code}/economy": {
        "get": {
          ...
          "responses": {
            ...
            "404": {
              "description": "No unit has that identifier, it's in another collection, or it is counted by arrondissement.",
              "content": {
                "application/problem+json": {
                  "schema": {
                    "$ref": "#/components/schemas/Problem"
