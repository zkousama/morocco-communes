...
export const reference = {
    ...
    "paths": {
      ...
      "/api/{collection}/{code}/economy": {
        "get": {
          ...
          "responses": {
            "200": {
              "description": "The unit's establishments.",
              "content": {
                "application/json": {
                  "schema": {
                    "allOf": [
      ...
      "/api/economy.json": {
        "get": {
          ...
          "responses": {
            "200": {
              "description": "Morocco's establishments.",
              "content": {
                "application/json": {
                  "schema": {
                    "allOf": [
      ...
      "/api/{collection}/{code}/housing": {
        "get": {
          ...
          "responses": {
            "200": {
              "description": "The unit's urban housing stock.",
              "content": {
                "application/json": {
                  "schema": {
                    "allOf": [
      ...
      "/api/housing.json": {
        "get": {
          ...
          "responses": {
            "200": {
              "description": "Morocco's urban housing stock.",
              "content": {
                "application/json": {
                  "schema": {
                    "allOf": [
        ...
        "Economy": {
          ...
          "properties": {
            ...
            "basis": {
              ...
              "description": "Present on the 6 cities the census counts by arrondissement: these figures are the exact sum of their arrondissements rather than a count HCP publishes for the city. Absent everywhere else."
            },
            "topics": {
              "type": "object",
              "description": "By topic, then by key: establishments, sector, size, founded. Every figure is a count of establishments, of permanent jobs, or of weekly souks."
            }
          }
        },
        "Housing": {
          ...
          "properties": {
            ...
            "topics": {
              "type": "object",
              "description": "By topic, then by key: dwellings, occupancy, type, age, ageByType, walls, roofs, networks. Every figure but dwellings.total is a percentage of that unit's urban dwellings."
            },
            "urbanCentres": {
              "type": "array",
              "description": "A commune's urban centres, each with the same fields.",
  ...
  "operations": [
    ...
    {
      "path": "/api/{collection}/{code}/economy",
      "method": "get",
      "op": {
        "operationId": "getEconomy",
        "summary": "A unit's economic establishments, counted during the 2024 census",
    ...
    {
      "path": "/api/{collection}/{code}/housing",
      "method": "get",
      "op": {
        "operationId": "getHousing",
        "summary": "A unit's urban housing stock, counted at the 2024 census",
  ...
  "examples": {
    ...
    "getEconomy": {
      "request": "/api/communes/tiznit/economy",
      "body": {
        "data": {
          "code": "09.581.01.07",
    ...
    "getHousing": {
      "request": "/api/communes/tiznit/housing",
      "body": {
        "data": {
          "code": "09.581.01.07",
          "codeDigits": "095810107",
  ...
  "files": [
    ...
    {
      "key": "neighbours",
      "pattern": "/api/communes/{code}/neighbours.json",
      "example": "/api/communes/09.581.01.07/neighbours.json"
    },
    {
    ...
    {
      "key": "regionsEconomy",
      "pattern": "/api/regions/economy.json",
      "example": "/api/regions/economy.json"
    },
    {
      "key": "provincesEconomy",
      "pattern": "/api/provinces/economy.json",
      "example": "/api/provinces/economy.json"
    },
    {
      "key": "arrondissementsIndicators",
      "pattern": "/api/arrondissements/indicators.json",
      "example": "/api/arrondissements/indicators.json"
    },
    {
      "key": "arrondissementsEconomy",
      "pattern": "/api/arrondissements/economy.json",
      "example": "/api/arrondissements/economy.json"
    },
    {
      "key": "regionsHousing",
      "pattern": "/api/regions/housing.json",
      "example": "/api/regions/housing.json"
    },
    {
      "key": "provincesHousing",
      "pattern": "/api/provinces/housing.json",
      "example": "/api/provinces/housing.json"
    },
    {
      "key": "tiles",
