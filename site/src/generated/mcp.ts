...
export const mcp = {
  "instructions": "Morocco's administrative divisions: régions, provinces and préfectures, cercles, communes and arrondissements, with HCP census population for 2024 and 2014 and OpenStreetMap boundaries. Units are identified by HCP geographic codes such as 01.511.01.0, and a slug such as tanger works wherever a code does. To answer a question about a named place, call search first to get its code.",
  "tools": [
    {
      "name": "search",
    ...
    },
    {
      ...
      "description": "Communes within a radius of a point, nearest first. Distance is measured to each commune's centroid, so the nearest commune is not always the one that contains the point.",
      "params": [
        {
          "name": "lat",
          "required": true,
