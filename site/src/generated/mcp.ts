...
export const mcp = {
  ...
  "tools": [
    ...
    },
    {
      ...
      "description": "For a place with a 2024 census figure that stands out, up to 3 possible reasons a language model proposed. Each rests on a fact about the place, checked against the census, and a link between that fact and the figure, tested for consistency across places of the same level where a test fits it, and marked proposed only otherwise. This explains a figure rather than stating it; get_indicators, get_economy and get_housing give the figures themselves. Most places have nothing here yet.",
      "params": [
        {
          "name": "unit",
          "required": true,
          "schema": {
            "type": "string",
            "minLength": 1,
            "description": "A région, province, commune or arrondissement, by code or slug."
          }
        },
        {
          "name": "level",
