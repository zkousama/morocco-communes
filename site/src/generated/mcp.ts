...
export const mcp = {
  "instructions": "Morocco's administrative divisions: régions, provinces and préfectures, cercles, communes and arrondissements, with HCP census population for 2024 and 2014 and OpenStreetMap boundaries. Units are identified by HCP geographic codes such as 01.511.01.0, and a slug such as tanger works wherever a code does. To answer a question about a named place, call search first to get its code. get_commune answers about a commune or an arrondissement, and get_unit about a région, a province or a cercle. For coordinates, commune_at gives the commune that contains them. get_indicators gives the census figures on age, education, languages, work and housing for any unit or the whole country, from 2024, from 2014, or both to see what changed, and list_communes can rank communes by any of them or by the change since 2014. get_economy gives the 2024 count of economic establishments for the same units: businesses by sector, by size and by when they were founded, and the permanent jobs they hold.",
  "tools": [
    {
      "name": "search",
    ...
    },
    {
      ...
      "params": [
        ...
        },
        {
          ...
          "required": false,
          "schema": {
            "description": "A field to order by: code, name, population, change, density, area, or a census indicator by its path, such as labour.unemploymentRate or amenities.runningWater, as get_indicators names them. Put 2014. before the path for the 2014 figure, or change. for how far it moved since, as in change.illiteracy.rate10Plus. An establishment count goes under economy., as in economy.establishments.jobs or economy.sector.commerce, as get_economy names them. A leading minus puts the largest first. Code order when left out.",
            "type": "string"
          }
        },
        {
