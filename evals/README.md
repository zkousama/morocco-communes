...
`cases.ts` holds 34 questions: lookups, misspellings and exonyms, French and Arabic,
coordinates, rankings, the census indicators, 2 things the tools once couldn't answer
directly, and a place that doesn't exist. Every expected figure is read from `data/v1`,
